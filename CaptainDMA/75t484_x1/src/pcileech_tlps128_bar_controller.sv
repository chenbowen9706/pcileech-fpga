...
`define PORTSC_PLS_MASK     32'hf
`define PORTSC_PP           1<<9
`define PORTSC_SPEED_SHIFT      10
`define PORTSC_SPEED_MASK   32'hf
...
module pcileech_bar_impl_bar(
    ...
    reg [31:0] imod1;
    reg [31:0] erstsz1;
    reg [31:0] erstba_low1;
    reg [31:0] erstba_high1;
    reg [31:0] erdp_low1;
    reg [31:0] erdp_high1;
    ...
    reg [31:0] imod2;
    reg [31:0] erstsz2;
    reg [31:0] erstba_low2;
    reg [31:0] erstba_high2;
    reg [31:0] erdp_low2;
    reg [31:0] erdp_high2;
    ...
    reg [31:0] imod3;
    reg [31:0] erstsz3;
    reg [31:0] erstba_low3;
    reg [31:0] erstba_high3;
    reg [31:0] erdp_low3;
    reg [31:0] erdp_high3;
    ...
    endcase
        ...
        begin
            if ((val & `USBCMD_RS) && !(usbcmd & `USBCMD_RS)) begin
                ...
                usbsts <= usbsts | `USBSTS_HCH;
                crcr_low <= crcr_low & ~`CRCR_CRR;
            end

            if (val & `USBCMD_CSS) begin
                usbsts <= usbsts & ~`USBSTS_SRE;
            end
            if (val & `USBCMD_CRS) begin
                usbsts <= usbsts | `USBSTS_SRE;
            end
            usbcmd <= val & 32'hc0f;
            if (val & `USBCMD_HCRST) begin
                usbcmd <= 0;
                usbsts <= `USBSTS_HCH;
                dnctrl <= 0;
                crcr_low <= 0;
            ...
            if (iman1 & `IMAN_IP && iman1 & `IMAN_IE && usbcmd & `USBCMD_INTE) 
            begin
                o_int <= 1;
                iman1 <= iman1 & ~`IMAN_IP;
            end
